                    ...
                    <>
                        ...
                        <div className="carousel carousel-slider helper-slider" id={"helper-slider"}>
                            ...
                            <div className="carousel-item red white-text">
                                <div className={"row"}>
                                    <div className={"col s6"}>
                                        <img className={"slider-gif-image"} src={""} alt={"Drag Drop GIF"}/>
                                    </div>
                            ...
                            <div className="carousel-item teal white-text">
                                <div className={"row"}>
                                    <div className={"col s6"}>
                                        <img className={"slider-gif-image"} src={""} alt={"Connect GIF"}/>
                                    </div>
                                    <div className={"col s6 left"}>
                                        <h1>Step 2</h1>
                                        <h3>Connect</h3>
                            ...
                            <div className="carousel-item green white-text">
                                <div className={"row"}>
                                    <div className={"col s6"}>
                                        <img className={"slider-gif-image"} src={""} alt={"Configure GIF"}/>
                                    </div>
                                    <div className={"col s6 left"}>
                                        <h1>Step 3</h1>
                                        <h3>Configure</h3>
                            ...
                            <div className="carousel-item blue white-text">
                                <div className={"row"}>
                                    <div className={"col s6"}>
                                        <img className={"slider-gif-image"} src={""} alt={"Generate GIF"}/>
                                    </div>
                                    <div className={"col s6 left"}>
                                        <h1>Step 4</h1>
                                        <h3>Generate & Call</h3>
